# QuantZhai Codex Core Qwenified Reference Snapshot

Source repo: `h4rm0n1c/quantzhai`  
Source path: `prompts/codex-core-qwenified.md`  
Source ref checked: `2b2fe8b18edb01cab516725f41696266badc5446`  
Source selection path: `config/default/model-overrides.json` sets `system_prompt_file` to `prompts/codex-core-qwenified.md`.

This file is a reference snapshot for HSM-side prompt development.

It is not live QuantZhai authority. Re-check QuantZhai before treating this as current runtime behaviour.
