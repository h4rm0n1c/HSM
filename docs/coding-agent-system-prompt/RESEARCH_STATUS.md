...
Summary: slices 0-11 are canonically integrated. Slice 12 and the project smell audit are active corrections, but they must be integrated **one layer at a time**. The current active control document is `canonical-integration-pass-2026-06-17.md`. Candidate prompt drafting remains paused until the user explicitly resumes it.
...
I1 research-layer consolidation  NEXT
...
| 12 | Research correction added / not yet canonically merged | `slice-12-evidence-gated-action.md`, Slice 12 sidecars | I1 research-layer consolidation |
| smell audit | Added / not yet canonically applied | `project-smell-audit-2026-06-17.md` | I1/I2 abstraction cleanup |
| integration pass | I0 complete | `canonical-integration-pass-2026-06-17.md` | I1 research-layer consolidation |
...
## Immediate Next Slice: I1

I1 must update only the research layer:
